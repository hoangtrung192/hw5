...
import { signAndSubmitTx } from "../utilities/utilities.ts";
import {
    PaymentKeyHash,
    SpendingValidator,
    UTxO,
...
export default function Oracle() {
    ...
    const [rate, setRate] = useState(100n); // set rate default 100 cent = 1$
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////
    ///////////////////////////////////// DEPLOY ORACLE ///////////////////////////////////////////
//Send NFT + initial price to Oracle Contract
